...
* Исправлена проблема в выпадающем списке полнотекстового поиска (#178553)
* Добавлено логирование запросов (#178612)
* Добавлена возможность явно указывать домен пользователей при синхронизации из LDAP. В настройке Ldap.UsersDomain указывается необходимый домен (#178570)
* Добавлена возможность в форме фильтрации указывать множество фильтров по одному полю. Добавлена возможность задавать в строку поиска логические выражения "ИЛИ" (#178675)

### 8.6.5.0

* Добавлена проверка пути скачиваемого файла (#178502)
