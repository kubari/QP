...
{
    internal class PageTemplateProfile : Profile
    {
        public PageTemplateProfile()
        {
            CreateMap<PageTemplateDAL, PageTemplate>(MemberList.None);
            CreateMap<PageTemplate, PageTemplateDAL>(MemberList.None)
