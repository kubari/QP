...
{
    internal class ArticleScheduleProfile : Profile
    {
        public ArticleScheduleProfile()
        {
            CreateMap<ArticleSchedule, ArticleScheduleDAL>(MemberList.None)
            ...
            CreateMap<ArticleScheduleDAL, ArticleScheduleTask>(MemberList.None)
        ...
        private static void ProceedComplexMappingToDal(ArticleSchedule item, ArticleScheduleDAL result)
        {
            ...
            if (result.FreqType is ScheduleFreqTypes.OneTime or ScheduleFreqTypes.Publishing)
            {
                ProceedOneTimeScheduleToDal(result);
            }
            else if (result.FreqType is >= ScheduleFreqTypes.RecurringDaily and <= ScheduleFreqTypes.RecurringMonthlyRelative)
            {
        ...
        private static void ProceedComplexMappingToBiz(ArticleScheduleDAL dal, ArticleSchedule result)
        {
            ...
            result.Recurring = result.ScheduleType == ScheduleTypeEnum.Recurring ? ProceedDalToRecurringSchedule(dal) : RecurringSchedule.Empty;
