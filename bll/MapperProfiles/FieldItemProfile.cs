...
{
    internal class FieldItemProfile : Profile
    {
        public FieldItemProfile()
        {
            CreateMap<DataRow, FieldListItem>(MemberList.None)
                ...
                .ForMember(biz => biz.Size, opt => opt.MapFrom(row => row.Field<decimal>("Size").ToString(CultureInfo.InvariantCulture)))
